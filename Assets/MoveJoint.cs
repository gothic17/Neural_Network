...
public class MoveJoint : MonoBehaviour {
	...
	void MoveWithKey(float tiltAroundX, float tiltAroundY, float tiltAroundZ) {
        ...
        //print("X) " + gameObject.transform.localEulerAngles.x + " - " + initialLocalRotationX + " = " + (initialLocalRotationX - gameObject.transform.localEulerAngles.x));
        //print("Y) " + gameObject.transform.localEulerAngles.y + " - " + initialLocalRotationY + " = " + (initialLocalRotationY - gameObject.transform.localEulerAngles.y));
        //print("Z) " + gameObject.transform.localEulerAngles.z + " - " + initialLocalRotationZ + " = " + (initialLocalRotationZ - gameObject.transform.localEulerAngles.z));
